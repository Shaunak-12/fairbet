...
export class HeaderComponent implements OnInit {
	...
	constructor(private router: Router, private appService: AppService, private store: Store<AppState>, private apiservice: ApiService, private utilities: CommonFunctionService,) { }
