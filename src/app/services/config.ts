export const config: any = {
  ...
  "SaveUserTrackingDetails": "user/SaveUserTrackingDetails",
  "getusertrackingdetails": "user/GetUserTrackingDetails",
  "getbuttonstatus": "user/UserTrackingButtonStatus",

  "SaveFirstCallConversation": "user/SaveFirstCallConversation",
  "Click2FirstCallvicicdial": "user/Click2FirstCallvicicdial"
}